...
func TestmySlice2Stream(t *testing.T) {
	s := streams.New()
...
func TestmySlice2StreamSplice(t *testing.T) {
	s := streams.New()
	values := valuesFormySlice2Stream()
...
func TestmySlice2StreamItem(t *testing.T) {
	s := streams.New()
	values := valuesFormySlice2Stream()
	strong := &mySlice2Stream{Stream: s, Value: values[1]}
	item0 := strong.Item(0)
...
func TestmySlice2PStream(t *testing.T) {
	s := streams.New()
...
func TestmySlice2PStreamSplice(t *testing.T) {
	s := streams.New()
	values := valuesFormySlice2PStream()
...
func TestmySlice2PStreamItem(t *testing.T) {
	s := streams.New()
	values := valuesFormySlice2PStream()
	strong := &mySlice2PStream{Stream: s, Value: values[1]}
	item0 := strong.Item(0)
